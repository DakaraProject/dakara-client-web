...
export const IsPlaylistManagerOrOwner = connect(mapStateToProps)(
...
export const IsPlaylistManager = connect(mapStateToProps)(
  class extends PermissionBase {
    static propTypes = {
      ...PermissionBase.propTypes,
    }
...
export const IsPlaylistUser = connect(mapStateToProps)(
  class extends PermissionBase {
    static hasPermissionCustom(user) {
      return (
        user.playlist_permission_level === 'u' ||
...
CanAddToPlaylist = connect(mapStateToPropsKaraoke, {})(CanAddToPlaylist)

 ...
 */
export const addSongToPlaylistWithOptions = (
  songId,
 ...
 */
export const reorderPlaylistEntry = ({
  playlistEntryId,
  beforeId,
  afterId,
} = {}) => {
...
export const loadPlayerToken = (karaokeId) => ({
  [FETCH_API]: {
    ...
    method: 'GET',
    types: [PLAYER_TOKEN_REQUEST, PLAYER_TOKEN_SUCCESS, PLAYER_TOKEN_FAILURE],
  },
})
...
export const loadPlayerErrors = ({ page = 1, query } = {}) => {
  ...
  return {
    [FETCH_API]: {
      endpoint: `${baseUrl}/playlist/player/errors/?${queryStr}`,
      method: 'GET',
      types: [

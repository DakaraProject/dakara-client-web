...
const mapStateToPropsPlayerTokenBox = (state) => ({
  ...
  responseOfCreatePlayerToken:
    state.alterationsResponse.unique.createPlayerToken,
  responseOfRevokePlayerToken:
    state.alterationsResponse.unique.revokePlayerToken,
  karaokeState: state.playlist.karaoke,
})

PlayerTokenBox = connect(mapStateToPropsPlayerTokenBox, {
  loadPlayerToken,
  createPlayerToken,
  revokePlayerToken,
})(PlayerTokenBox)
...
Tokens = connect(mapStateToProps, { revokeToken })(Tokens)

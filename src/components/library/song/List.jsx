    ...
    return (
      <div id="song-library">
          ...
          help={
            <>
              ...
              <ul>
                ...
                <li>
                  Hash tag to target tags: <span className="example">#tag</span>
                </li>
              </ul>
            </>
          }
        ...
        <div className="song-list">
          <ListingFetchWrapper status={this.props.songState.status}>
            <ul className="library-list listing">{libraryEntrySongList}</ul>
          </ListingFetchWrapper>
          <Navigator
            count={count}
